...
export function TrashList({ emails, selectedEmail, onSelectEmail, onToggleStar, onToggleTrash }: TrashListProps) {
  return (
    <div className="w-full lg:w-96 border-r border-border bg-background flex flex-col">
      ...
      <div className="p-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">{emails.length} trashed</p>
        </div>
        ...
        {emails.length === 0 && (
          <div className="flex items-center justify-center h-32 text-muted-foreground">
            <div className="text-center">
              ...
              <p className="text-sm">No trashed emails</p>
            </div>
          </div>
        )}
      </div>
