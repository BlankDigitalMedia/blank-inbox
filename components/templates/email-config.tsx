...
export const emailTemplateConfig: any = {
  root: {
    ...
    render: ({ children, backgroundColor, contentBackground, contentWidth, outerPadding }: any) => {
  ...
  components: {
    Hero: {
      ...
      render: ({ eyebrow, headline, description, buttonText, buttonUrl, imageUrl, align }: any) => (
        <Section
          style={{
    ...
    ButtonBlock: {
      ...
      render: ({ text, url, variant, align }: any) => {
        const primaryStyles = {
          backgroundColor: "#4338ca",
          color: "#ffffff",
...
export type EmailTemplateConfig = Config
